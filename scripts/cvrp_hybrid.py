...
def solve_cvrp_hybrid (filepath ,ga_time_limit =60 ,ilp_time_limit =600 ,population_size =100 ,generations =500 ,mutation_rate =0.2 ,tournament_size =3 ,seed =None ,show_plot =True ):
    print ("Krok 1: Inicjalizacja Algorytmem Genetycznym")


    ga_cost ,ga_routes =solve_cvrp_ga (filepath ,time_limit =ga_time_limit ,population_size =population_size ,generations =generations ,mutation_rate =mutation_rate ,tournament_size =tournament_size ,seed =seed ,save_csv =False ,show_plot =False )

    print ("")
    print (f"Krok 2: Uruchamianie solvera ILP")
